 ...
 * (`focus-visible:outline-accent`, 2px / 2px offset). Pure markup → Server
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-surface/70 backdrop-blur-md">
      <nav className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-6 py-3">
        ...
        <a
          href="#main"
          className="rounded-[var(--radius-sm)] font-display text-lg font-semibold tracking-[-0.01em] text-text transition-colors duration-150 hover:text-text focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        >
          Jacky Zhang
        </a>
            ...
            <li key={link.href}>
              <a
                ...
                className={cn(
                  ...
                  "after:absolute after:inset-x-3 after:bottom-1 after:h-0.5 after:origin-left after:scale-x-0 after:bg-accent after:transition-transform after:duration-150 hover:after:scale-x-100 focus-visible:after:scale-x-100",
                  "focus-visible:text-text focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent",
                )}
              >
                {link.label}
              </a>
